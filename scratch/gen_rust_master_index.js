...
<head>
  ...
  <meta name="description" content="Master Rust programming with our complete roadmap covering Rust introduction, prerequisites, installation, first program, Cargo, variables, scalar/compound types, functions, control flow, loops, ownership, borrowing, slices, lifetimes, structs, enums, pattern matching, vectors, strings, hash maps, and projects." />
...
<div class="layout">
  ...
  <main class="content">
    ...
    <div class="page-meta">
      ...
      <span class="badge">🟢 22 Chapters Complete</span>
      <span class="badge">📂 Phases 1 to 7 Complete</span>
      <span class="badge">📅 2026 Edition</span>
    </div>

    <div class="topic-pill-box">
      <span class="topic-pill-label">📌 Covered in this course:</span>
      <span class="topic-pill-text">What is Rust · Memory Safety · Zero-Cost Abstractions · Cargo Basics · Variables &amp; Mutability · Functions &amp; Control Flow · Ownership Rules · Borrowing &amp; References · Slices · Lifetimes · Structs &amp; impl · Enums &amp; Option&lt;T&gt; · Pattern Matching · Vectors, Strings &amp; Hash Maps · Collections Project</span>
    </div>
    ...
    <div style="background: linear-gradient(135deg, rgba(183,65,14,0.15), rgba(20,24,32,0.6)); border: 1px solid rgba(183,65,14,0.3); border-radius: 12px; padding: 24px; margin-bottom: 32px;">
      ...
      <div style="display:flex; gap:12px; flex-wrap:wrap;">
        ...
        <a href="/blog-rust/09-functions.html" style="background:var(--bg3); border:1px solid var(--border); color:var(--text); font-weight:700; padding:10px 16px; border-radius:8px; text-decoration:none;">Phase 4: Functions &amp; Flow →</a>
        ...
        <a href="/blog-rust/16-structs.html" style="background:var(--bg3); border:1px solid var(--border); color:var(--text); font-weight:700; padding:10px 16px; border-radius:8px; text-decoration:none;">Phase 6: Structs &amp; Enums →</a>
...
console.log('✅ Generated public/blog-rust.html master index page successfully with 22 chapters!');
