...
// 2. Define Complete 30-Chapter REST API Masterclass Data Structure across 10 Phases
const restPhases = [
  {
...
GET /api/v1/courses?cursor=eyJpZCI6MTAwfQ&limit=10`
  ...
  {
    phaseTag: 'Phase 08', phaseTitle: 'Security and Authentication', icon: '🔒',
    chapters: [
      {
        num: 21, file: '21-api-authentication.html', title: 'API Authentication & JWT',
        subtopics: 'API Keys · Bearer Tokens · JWT Header, Payload & Signature · Access tokens vs Refresh tokens · OAuth 2.0 flows · CORS headers · OWASP API Security',
        summary: 'Protect REST API endpoints using API keys, JWT access/refresh token rotation, CORS headers, and OWASP security practices.',
        code: `Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...`
      },
      {
        num: 22, file: '22-caching-and-rate-limiting.html', title: 'Caching & Rate Limiting',
        subtopics: 'Cache-Control · ETag & 304 Not Modified · Token Bucket rate limiting · 429 Too Many Requests · Redis rate limit counters',
        summary: 'Optimize response times with HTTP ETag caching and protect backends from abusive traffic using Redis rate limiting.',
...
Retry-After: 60`
  ...
  {
    phaseTag: 'Phase 09', phaseTitle: 'API Documentation & Gateways', icon: '📖',
    chapters: [
      {
        num: 23, file: '23-openapi-spec-and-swagger.html', title: 'OpenAPI Spec & Swagger',
        subtopics: 'OpenAPI 3.0 specification · Swagger UI · YAML/JSON API contracts · Postman Collections · Bruno CLI · Contract testing',
        summary: 'Document and test REST APIs interactively using OpenAPI 3.0 specs, Swagger UI, Postman, and Bruno CLI.',
        code: `openapi: 3.0.0
info:
  ...
  version: 1.0.0`
      ...
      {
        num: 24, file: '24-api-gateways-and-microservices.html', title: 'API Gateways & Webhooks',
        subtopics: 'Kong Gateway · NGINX reverse proxy · Microservices communication · Webhook event notifications · HMAC SHA-256 signatures',
        summary: 'Route client requests through API Gateways and broadcast real-time event updates via HMAC-signed Webhooks.',
        code: `X-Signature-SHA256: 7d2b8b9f1a2...`
      }
    ]
  },
  {
    phaseTag: 'Phase 10', phaseTitle: 'Real-World Implementations & Quiz', icon: '🏆',
    chapters: [
      {
        num: 25, file: '25-building-a-restful-ecommerce-api.html', title: 'E-Commerce REST API Design',
...
POST /api/v1/checkout/orders`
      ...
      {
        num: 26, file: '26-nodejs-express-rest-api-implementation.html', title: 'Node.js Express REST API',
...
app.get('/api/v1/courses', (req, res) => {
  res.json({ success: true, data: [] });
      ...
      {
        num: 27, file: '27-python-fastapi-rest-api-implementation.html', title: 'Python FastAPI REST API',
...
def get_courses():
    return {"status": "success", "courses": []}`
      ...
      {
        num: 28, file: '28-rest-api-deployment-and-monitoring.html', title: 'REST API Deployment & Monitoring',
      ...
      {
        num: 29, file: '29-rest-api-best-practices-checklist.html', title: 'REST API Best Practices Checklist',
        subtopics: '20 Essential REST API Engineering Rules · URI Naming · HTTP Methods · Status Codes · Security · Performance & Versioning',
        summary: 'Review 20 critical engineering rules and design guidelines for building robust production REST APIs.',
        code: `/* 1. Use Nouns, Not Verbs in URIs
2. Return Appropriate Status Codes
3. Always Version Your APIs */`
      },
      {
        num: 30, file: '30-rest-api-quiz.html', title: 'REST API Practice Quiz',
...
<head>
  ...
  <title>REST API Complete Roadmap — 30 Chapters, 10 Phases (2026 Edition) | Our Compiler</title>
  <meta name="description" content="Master REST API design, HTTP fundamentals, status codes, JSON formatting, security, JWT authentication, caching, rate limiting, OpenAPI specification, Node.js Express, Python FastAPI, and deployment with our complete 30-chapter roadmap across 10 phases." />
  <meta name="keywords" content="rest api tutorial, learn rest api, rest api masterclass, http request, http response, status codes, openapi, swagger, jwt auth, api security, express js api, fastapi" />
...
<div class="layout">
  ...
  <main class="content">
    ...
    <h1 class="page-title">REST API Complete Masterclass (30 Chapters, 10 Phases)</h1>
    ...
    <div class="topic-pill-box">
      ...
      <span class="topic-pill-text">REST API Ante Enti? · HTTP Requests &amp; Responses · HTTP Methods &amp; Status Codes · Resource &amp; URL Design · Versioning · JSON Schemas · CRUD API Operations (POST, GET, PUT, PATCH, DELETE) · Query Parameters, Pagination &amp; Sorting · Request Validation &amp; Errors · Auth, JWT &amp; Security · Caching &amp; Rate Limiting · OpenAPI, Swagger &amp; Postman · Express.js &amp; FastAPI Implementation · Deployment &amp; Quiz</span>
    </div>

    <div class="intro-box">
      <p>Welcome to <strong>Our Compiler's REST API Complete Master Course</strong>. REST (Representational State Transfer) is the architectural foundation of modern web and mobile applications. This comprehensive 30-chapter bootcamp guides you through HTTP fundamentals, status code semantics, clean URL design, security, JWT authentication, OpenAPI documentation, and building production REST APIs in Express.js and FastAPI.</p>
    </div>
    ...
    <div style="background:linear-gradient(135deg,rgba(16,185,129,0.12),rgba(20,24,32,0.6));border:1px solid rgba(16,185,129,0.3);border-radius:12px;padding:24px;margin:28px 0;">
      ...
      <p style="color:var(--text2);margin-bottom:16px;font-size:14.5px;">Choose where to start: explore REST introduction, HTTP methods, resource naming, CRUD operations, request validation, or backend API implementations:</p>
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        ...
        <a href="/blog-rest-api/06-resources.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 3: Resource Design →</a>
        <a href="/blog-rest-api/11-create-resource.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 5: CRUD API →</a>
        <a href="/blog-rest-api/16-pagination.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 6: Pagination →</a>
        <a href="/blog-rest-api/18-request-validation.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 7: Request Validation →</a>
        <a href="/blog-rest-api/26-nodejs-express-rest-api-implementation.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 10: Express.js API →</a>
      </div>
    </div>
    ...
    <div class="author">
      ...
      <div>
        ...
        <span>REST API Complete Masterclass · 30 Chapters · 10 Phases · 2026 Edition</span>
      </div>
    </div>
...
// 4. Generate all 30 Chapter HTML Files inside public/blog-rest-api/ adhering to the 15-Section Lesson Layout
...
console.log('✅ Generated all 30 REST API Masterclass chapter files in public/blog-rest-api/ successfully!');
