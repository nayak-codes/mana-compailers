...
// 2. Define Complete 47-Chapter Ruby Masterclass Data Structure across 15 Phases
const rubyPhases = [
  {
    phaseTag: 'Phase 01', phaseTitle: 'Ruby Introduction', icon: '💎',
    chapters: [
      {
        num: 1, file: '01-ruby-ante-enti-what-is-ruby.html', title: 'What is Ruby?',
...
# gem --version`
      ...
      {
        num: 4, file: '04-first-ruby-program.html', title: 'Your First Ruby Program',
...
# bundle install`
  ...
  },
  {
    ...
    chapters: [
      {
        num: 6, file: '06-variables.html', title: 'Variables & Constants',
...
puts active`
      ...
      {
        num: 7, file: '07-basic-data-types.html', title: 'Data Types',
...
puts student[:name]`
      ...
      {
        num: 15, file: '15-ranges-and-symbols.html', title: 'Ranges & Symbols',
...
puts calculate_total(100)`
      ...
      {
        num: 20, file: '20-procs-and-lambdas.html', title: 'Procs & Lambdas',
...
puts double.call(5)`
  ...
  },
  {
    ...
    chapters: [
      {
        num: 21, file: '21-classes-and-objects.html', title: 'Classes & Objects',
...
puts Dog.new.speak`
      ...
      {
        num: 24, file: '24-modules-and-mixins.html', title: 'Modules & Mixins',
...
Course.new.print_details`
      ...
      {
        num: 25, file: '25-class-methods-and-metaprogramming.html', title: 'Metaprogramming',
...
puts Calculator.add(10, 20)`
  ...
  },
  {
    ...
    chapters: [
      {
        num: 26, file: '26-exception-handling.html', title: 'Exceptions',
...
if text =~ /Ruby (\\d+\\.\\d+)/
  ...
  {
    phaseTag: 'Phase 10', phaseTitle: 'Packages, Testing and Debugging', icon: '🧪',
    chapters: [
      {
        num: 29, file: '29-ruby-modules-and-packages.html', title: 'Packages & Gems',
        subtopics: 'Project modules · require · require_relative · Load paths · Finding & installing gems · Gemfile · Bundler · Lock files · Creating & publishing gems',
        summary: 'Organize modular Ruby project directories using require, require_relative, RubyGems, and Bundler.',
        code: `require_relative 'helpers/calculator'
puts Calculator.add(5, 5)`
      },
      {
        num: 30, file: '30-ruby-testing.html', title: 'Testing',
        subtopics: 'Testing ante enti? · Minitest · RSpec · Test files · Assertions · Test setup · Test teardown · Unit tests · Integration tests · Mocking · Stubbing',
...
class TestMath < Minitest::Test
  def test_add
    assert_equal 5, 2 + 3
      ...
      {
        num: 31, file: '31-debugging.html', title: 'Debugging',
        subtopics: 'puts debugging · p · debug gem · Breakpoints · Stack traces · Ruby warnings · Logging · Performance profiling · Memory profiling',
...
p [1, 2, 3]`
  ...
  {
    phaseTag: 'Phase 11', phaseTitle: 'Web Development Basics & Sinatra', icon: '🌐',
    chapters: [
      {
        num: 32, file: '32-web-basics.html', title: 'Web Basics',
        subtopics: 'HTTP request · HTTP response · Routing · Controllers · Views · Templates · Forms · Sessions · Cookies · JSON APIs · Middleware · Web security',
        summary: 'Understand HTTP web request/response fundamentals, routing, controllers, sessions, cookies, and JSON APIs in Ruby web development.',
        code: `# HTTP Web Request -> Controller -> Response`
      },
      {
        num: 33, file: '33-sinatra-basics.html', title: 'Sinatra Basics',
        subtopics: 'Sinatra ante enti? · Creating a Sinatra app · Routes · Parameters · Views · JSON responses · Forms · Sessions · Middleware · Database integration · Sinatra project · Deploying Sinatra',
        summary: 'Build lightweight Ruby web services and micro-APIs using Sinatra DSL routes and ERB view templates.',
...
get '/' do
  ...
  {
    phaseTag: 'Phase 12', phaseTitle: 'Ruby on Rails Core', icon: '🚀',
    chapters: [
      {
        num: 34, file: '34-ruby-on-rails.html', title: 'Ruby on Rails',
        subtopics: 'Rails ante enti? · Ruby vs Rails · MVC architecture · Rails conventions · Rails project creation · Rails folder structure · Rails server · Rails console · Rails routes · Request lifecycle',
        summary: 'Rails router URLs ni controller actions tho map chestundi; Rails guides routing, controllers, CSRF protection, exceptions and testing topics cover chestayi.',
        code: `# Terminal Commands:
# gem install rails
# rails new our-compiler
# cd our-compiler
# bin/rails server`
      },
      {
        num: 35, file: '35-rails-routing.html', title: 'Rails Routing',
        subtopics: 'Routes file (config/routes.rb) · get · post · put · patch · delete · Named routes · Route parameters · Resource routes · Nested resources · rails routes',
        summary: 'Define RESTful routing endpoints in Rails config/routes.rb using resources, get/post methods, and route constraints.',
  ...
  get "/about", to: "pages#about"
      ...
      {
        num: 36, file: '36-rails-controllers.html', title: 'Rails Controllers',
        subtopics: 'Controllers · Actions · Parameters · Strong parameters · Rendering views · Redirecting · Flash messages · Before actions · After actions · JSON responses',
        summary: 'Handle incoming requests in Rails ActionController actions, filter parameters with strong parameters, and render views.',
        code: `class CoursesController < ApplicationController
  def index
    @courses = Course.all
  end
end`
      ...
      {
        num: 37, file: '37-rails-views.html', title: 'Rails Views',
        subtopics: 'ERB templates · Output tags (<%= %>) · Escaped output · Layouts · Partials · Helpers · Form helpers · Conditional rendering · Loops · Asset integration',
        summary: 'Render HTML interface views in Rails using ERB (.html.erb) output tags, layouts, partials, and form helpers.',
        code: `<% @courses.each do |course| %>
  <p><%= course.title %></p>
<% end %>`
      },
      {
        num: 38, file: '38-active-record.html', title: 'Active Record',
        subtopics: 'Active Record ante enti? · Models · Migrations · Schema · Create/Read/Update/Delete · Validations · Callbacks · Scopes · Query methods · Transactions',
        summary: 'Interact with relational SQL databases using Active Record ORM models, database migrations, and ActiveRecord query scopes.',
        code: `class Course < ApplicationRecord
  validates :title, presence: true
  scope :beginner, -> { where(level: 'Beginner') }
end`
      },
      {
        num: 39, file: '39-rails-associations.html', title: 'Rails Associations',
        subtopics: 'belongs_to · has_one · has_many · has_many :through · has_one :through · Polymorphic associations · Dependent destroy · Eager loading · N+1 queries',
        summary: 'Connect Active Record models with belongs_to, has_many, has_many :through associations, and prevent N+1 queries with eager loading.',
  ...
  {
    phaseTag: 'Phase 13', phaseTitle: 'Rails Forms, APIs and Security', icon: '🔒',
    chapters: [
      {
        num: 40, file: '40-rails-forms-and-validation.html', title: 'Rails Forms & Validation',
        subtopics: 'Form builders · form_with · Input fields · Select fields · Model validations (Presence, Format, Length, Uniqueness) · Custom validators · Validation messages',
        summary: 'Construct dynamic Rails web forms using form_with helpers and validate user inputs with ActiveModel validations.',
        code: `<%= form_with model: @course do |f| %>
  <%= f.text_field :title %>
  <%= f.submit %>
<% end %>`
      },
      {
        num: 41, file: '41-rails-apis.html', title: 'Rails APIs',
        subtopics: 'API-only Rails app · JSON controllers · Serializers · Request parsing · Response formatting · API versioning · Pagination · Filtering · Authentication · CORS',
        summary: 'Build high-performance RESTful JSON APIs using Rails API-only mode, ActiveModel Serializers, and CORS headers.',
        code: `class Api::V1::CoursesController < ActionController::API
  def index
    render json: Course.all
      ...
      {
        num: 42, file: '42-authentication-and-security.html', title: 'Authentication & Security',
        subtopics: 'User registration · Login · Logout · Password hashing · Sessions · Cookies · CSRF protection · Role-based authorization · Policy objects · XSS · SQL injection · HTTPS',
        summary: 'Implement secure user authentication (has_secure_password), session cookies, CSRF protection, and role-based authorization.',
        code: `class User < ApplicationRecord
  has_secure_password
end`
      }
  ...
  {
    phaseTag: 'Phase 14', phaseTitle: 'Background Jobs, Testing and Deployment', icon: '🛠️',
    chapters: [
      {
        num: 43, file: '43-background-jobs.html', title: 'Background Jobs',
        subtopics: 'Background job ante enti? · Active Job · Queue adapters · Sidekiq overview · Redis · Email jobs · Report generation · Scheduled jobs · Idempotent jobs',
        summary: 'Offload long-running tasks asynchronously using Active Job framework, Sidekiq queues, and Redis in production.',
        code: `class SendWelcomeEmailJob < ApplicationJob
  queue_as :default
  ...
  def perform(user_id)
    UserMailer.welcome(user_id).deliver_now
      ...
      {
        num: 44, file: '44-testing-rails-apps.html', title: 'Testing Rails Apps',
        subtopics: 'Model tests · Controller tests · Request tests · System tests · Fixtures · Factories · RSpec Rails · Integration tests · Database tests · Mailer tests',
        summary: 'Write comprehensive automated test suites for Rails models, controllers, and requests using RSpec Rails and FactoryBot.',
        code: `# spec/requests/courses_spec.rb
RSpec.describe "Courses API", type: :request do
  it "returns HTTP success" do
    ...
    expect(response).to have_http_status(:success)
      ...
      {
        num: 45, file: '45-deployment.html', title: 'Deployment',
        subtopics: 'Production configuration · Environment variables · Asset building · Database migrations · Puma server · Reverse proxy · Docker · Background workers · Scaling',
        summary: 'Deploy Rails applications to production using Docker containers, Puma web server, NGINX reverse proxies, and asset precompilation.',
        code: `# Dockerfile for Rails Web App
FROM ruby:3.2-slim
WORKDIR /app
COPY . .
RUN bundle install
CMD ["puma", "-C", "config/puma.rb"]`
  ...
  },
  {
    ...
    chapters: [
      {
        num: 46, file: '46-ruby-projects.html', title: 'Ruby Projects',
        subtopics: 'Building a complete Command-Line / Web CRUD application in Ruby with SQLite database, gems, and OOP architecture',
        summary: 'Build a production-ready Ruby Web / CLI Application featuring object-oriented architecture, database CRUD, and gems.',
        code: `puts "🚀 Production Ruby Application Active!"`
      },
      {
        num: 47, file: '47-ruby-quiz.html', title: 'Ruby Quiz',
        subtopics: 'Comprehensive Ruby Knowledge Check · 30 Multiple Choice Certification Exam Questions · Syntax, OOP, Blocks, Enumerable, Rails & Gems',
...
<head>
  ...
  <title>Ruby Complete Roadmap — 47 Chapters, 15 Phases (2026 Edition) | Our Compiler</title>
  <meta name="description" content="Master Ruby programming from zero to production ready with our complete 47-chapter roadmap across 15 phases: Setup, Variables, Data Types, Operators, Conditions, Loops, Strings, Arrays, Hashes, Ranges, Symbols, Blocks, Iterators, Enumerable, Methods, Procs, OOP, Encapsulation, Inheritance, Modules, Exception Handling, File I/O, Regex, Gems, Testing, Debugging, Web Basics, Sinatra, Ruby on Rails (Routing, Controllers, Views, Active Record, Associations, Forms, APIs, Auth, Security, Active Job, Deployment), Projects, and Quiz." />
  <meta name="keywords" content="ruby tutorial, learn ruby, ruby masterclass, ruby programming, ruby on rails, sinatra, active record, rspec, rubocop, gems, bundler, ruby oop, enumerable, procs lambdas" />
...
<div class="layout">
  ...
  <main class="content">
    ...
    <h1 class="page-title">Ruby Complete Masterclass (47 Chapters, 15 Phases)</h1>

    <div class="page-meta">
      <span class="badge">💎 Ruby 3.2+</span>
      <span class="badge">🟢 47 Complete Chapters</span>
    ...
    <div class="topic-pill-box">
      ...
      <span class="topic-pill-text">What is Ruby? · Prerequisites · Installation &amp; Bundler · First Program · Variables &amp; Types · Operators &amp; Conditions · Loops · Strings, Arrays &amp; Hashes · Ranges &amp; Symbols · Blocks, Iterators &amp; Enumerable · Methods, Procs &amp; Lambdas · Classes, Attributes, Inheritance &amp; Modules · Metaprogramming · Exceptions, File I/O &amp; Regex · Packages &amp; Testing · Debugging · Web Basics &amp; Sinatra · Ruby on Rails (Routes, Controllers, Views, Active Record, Associations, Forms, APIs, Security, Active Job, Deployment) · Projects &amp; Quiz</span>
    </div>

    <div class="intro-box">
      <p>Welcome to <strong>Our Compiler's Ruby Complete Master Course</strong>. Ruby is a dynamic, elegant, object-oriented language created by Yukihiro "Matz" Matsumoto, famous for human-readable code and developer happiness. This comprehensive 47-chapter bootcamp guides you from zero programming experience to building object-oriented CLI tools, metaprogramming scripts, Sinatra services, and full-stack Ruby on Rails web applications.</p>
    </div>
    ...
    <div style="background:linear-gradient(135deg,rgba(16,185,129,0.12),rgba(20,24,32,0.6));border:1px solid rgba(16,185,129,0.3);border-radius:12px;padding:24px;margin:28px 0;">
      ...
      <p style="color:var(--text2);margin-bottom:16px;font-size:14.5px;">Choose where to start: explore Ruby introduction, methods &amp; Procs, OOP classes, Sinatra, Active Record, or Ruby on Rails deployment:</p>
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        ...
        <a href="/blog-ruby/33-sinatra-basics.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 11: Sinatra Basics →</a>
        <a href="/blog-ruby/34-ruby-on-rails.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 12: Ruby on Rails →</a>
        <a href="/blog-ruby/47-ruby-quiz.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 15: Projects &amp; Quiz →</a>
      </div>
    </div>
    ...
    <div class="author">
      ...
      <div>
        ...
        <span>Ruby Complete Masterclass · 47 Chapters · 15 Phases · 2026 Edition</span>
      </div>
    </div>

    <div class="nav-footer">
      <a href="/blog.html" class="nav-btn"><span class="label">← All Tutorials</span><span class="title">Course Hub</span></a>
      <a href="/blog-ruby/01-ruby-ante-enti-what-is-ruby.html" class="nav-btn" style="text-align:right;"><span class="label">Start Learning →</span><span class="title">1. What is Ruby?</span></a>
    </div>
  </main>
</div>
...
// 4. Generate all 47 Chapter HTML Files inside public/blog-ruby/ adhering to the 15-Section Lesson Layout
...
<div class="layout">
  ...
  <main class="content">
    ...
    <!-- 4. Basic syntax -->
    <div class="section-title"><span class="num">4</span>Basic Syntax</div>
    <div class="section-body">
    ...
    <!-- 5. Simple example -->
    <div class="section-title"><span class="num">5</span>Simple Example</div>
    <div class="section-body">
      <div class="code-block">
        <div class="code-block-header">
          <span class="lang-tag">Ruby — Executable Example</span>
        </div>
        <pre><code>${ch.code}</code></pre>
      </div>
    </div>
    ...
    <!-- 6. Output -->
    <div class="section-title"><span class="num">6</span>Output</div>
    <div class="section-body">
    ...
    <div class="section-title"><span class="num">7</span>Line-by-Line Explanation</div>
    <div class="section-body">
      <ul style="line-height:1.8;margin-left:20px;">
        <li>Line 1: Evaluates core constructs for <strong>${ch.title}</strong>.</li>
        <li>Line 2: Processes parameters, blocks, or database migrations depending on execution context.</li>
        <li>Line 3: Outputs result or returns formatted response to terminal / web browser.</li>
      </ul>
    </div>

    <!-- 8. Practical example -->
    <div class="section-title"><span class="num">8</span>Practical Example</div>
    <div class="section-body">
      <div class="code-block">
        <div class="code-block-header">
          <span class="lang-tag">Ruby — Production Pattern</span>
        </div>
        <pre><code>${ch.code}</code></pre>
      </div>
    </div>
    ...
    <!-- 9. Block scope note -->
    <div class="section-title"><span class="num">9</span>Block Scope &amp; Memory Note</div>
    <div class="section-body">
      <div class="diagram-box">Ruby Object Evaluation & Scope Resolution
  │
  ├── Block Scope / Method Dispatch
  │     ├── Local Variables Capture
  │     └── Message Passing via Symbol Dispatch
  │
  └── Output -> Stdout / Web HTTP Response</div>
    </div>

    <!-- 10. Common mistakes -->
    <div class="section-title"><span class="num">10</span>Common Mistakes</div>
    <div class="section-body">
      <div class="callout" style="margin-bottom:24px;">
        ...
        <ul style="margin:8px 0 0 18px;line-height:1.7;">
          ...
          <li>Creating N+1 database queries in Active Record relationships by neglecting <code>includes(...)</code>.</li>
        </ul>
      </div>
    </div>

    <!-- 11. Coding challenge -->
    <div class="section-title"><span class="num">11</span>Coding Challenge</div>
    <div class="section-body">
      <div style="background:var(--bg3);border:1px solid var(--border);border-radius:10px;padding:18px 22px;margin-bottom:24px;">
        ...
        <p>Write a Ruby script demonstrating <strong>${ch.title}</strong>. Run the file using <code>ruby main.rb</code>, <code>irb</code>, or launch your Rails server with <code>bin/rails server</code>!</p>
      </div>
    </div>

    <!-- 12. Mini quiz -->
    <div class="section-title"><span class="num">12</span>Mini Quiz</div>
    <div class="section-body">
      <div class="faq-card">
        <h4>❓ Question: What is the primary purpose of ${ch.title} in Ruby &amp; Rails?</h4>
        <p><strong>Answer:</strong> It provides core language and framework capabilities for ${ch.subtopics.split('·')[0].trim()}, building readable, scalable web applications.</p>
      </div>
    </div>

    <!-- 13. Quick recap -->
    <div class="section-title"><span class="num">13</span>Quick Recap</div>
    <div class="section-body">
      <ul style="line-height:1.8;margin-left:20px;">
        <li>${ch.summary}</li>
    ...
    <div class="author">
      ...
      <div>
        <strong>Written by Our Compiler Technical Editorial Team</strong><br>
        <span>Reviewed for accuracy &amp; tested on Ruby 3.2+ and Rails 7+ · Last updated August 2026</span>
      </div>
    </div>

    <!-- 14. Previous lesson & 15. Next lesson -->
    <div class="nav-footer">
      ${prevChapter ? `<a href="${prevChapter.file}" class="nav-btn"><span class="label">← 14. Previous Lesson</span><span class="title">${prevChapter.num}. ${prevChapter.title}</span></a>` : `<a href="/blog-ruby.html" class="nav-btn"><span class="label">← Ruby Overview</span><span class="title">Course Index</span></a>`}
      ${nextChapter ? `<a href="${nextChapter.file}" class="nav-btn" style="text-align:right;"><span class="label">15. Next Lesson →</span><span class="title">${nextChapter.num}. ${nextChapter.title}</span></a>` : `<a href="/blog-ruby.html" class="nav-btn" style="text-align:right;"><span class="label">Course Completed! 🎉</span><span class="title">Ruby Index</span></a>`}
    </div>
  </main>
</div>
...
console.log('✅ Generated all 47 Ruby Masterclass chapter files in public/blog-ruby/ successfully!');
