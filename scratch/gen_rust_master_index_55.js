...
<head>
  ...
  <meta name="description" content="Master Rust programming with our complete roadmap covering 55 chapters across 18 phases: Rust introduction, installation, Cargo, variables, scalar/compound types, functions, control flow, loops, ownership, borrowing, slices, lifetimes, structs, enums, pattern matching, vectors, strings, hash maps, modules, packages, workspaces, Option<T>, Result<T,E>, ? operator, error libraries, generics, traits, advanced lifetimes, iterators, closures, smart pointers, testing, docs, file I/O, CLI apps, threads, shared state, async Rust, networking, reqwest HTTP client, web frameworks, REST API project, SQL basics, database access, database project, unsafe Rust, FFI, embedded systems, WebAssembly (WASM), and advanced Cargo tooling." />
  <meta name="keywords" content="rust tutorial, learn rust, rust programming, cargo, rustc, memory safety, ownership, borrow checker, rust install, rust variables, rust modules, rust error handling, rust generics, rust traits, rust iterators, rust smart pointers, rust async, rust web, rust database, unsafe rust, embedded rust, rust webassembly, wasm-bindgen, cargo features" />
...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-accordion">
      ...
      <div class="accordion-content">
        <a href="/blog-rust/54-webassembly.html">54. WebAssembly</a>
        <a href="/blog-rust/55-advanced-cargo.html">55. Advanced Cargo</a>
      </div>
    </div>
  </aside>
  ...
  <main class="content">
    ...
    <div style="background: linear-gradient(135deg, rgba(183,65,14,0.15), rgba(20,24,32,0.6)); border: 1px solid rgba(183,65,14,0.3); border-radius: 12px; padding: 24px; margin-bottom: 32px;">
      <h3 style="color:#f97316; margin-bottom: 10px; font-size:18px;">🎯 Complete Rust Masterclass Roadmap (55 Chapters)</h3>
      <p style="color:var(--text2); margin-bottom: 16px; font-size:14.5px;">Master systems programming with Rust: explore memory safety pillars, install toolchains with rustup, build projects with Cargo, master ownership and borrowing rules, design custom structs and enums, organize code into modules and workspaces, handle errors gracefully, implement generic traits, utilize functional iterators and smart pointers, build async Tokio web services, access SQL databases, write unsafe code, build embedded firmware, compile to WebAssembly, and configure advanced Cargo build pipelines:</p>
      <div style="display:flex; gap:12px; flex-wrap:wrap;">
        ...
        <a href="/blog-rust/54-webassembly.html" style="background:var(--bg3); border:1px solid var(--border); color:var(--text); font-weight:700; padding:10px 16px; border-radius:8px; text-decoration:none;">Phase 18: WebAssembly →</a>
    ...
    <div class="curriculum-roadmap-container">
      ...
      <div class="phase-roadmap-card">
        <div class="phase-roadmap-header">
          <div class="phase-roadmap-title-wrap"><span class="phase-roadmap-icon">🚀</span><div><div class="phase-roadmap-tag">Phase 18</div><h3 class="phase-roadmap-title">WebAssembly and Advanced Tooling</h3></div></div>
          <span class="phase-roadmap-badge">2 Lessons</span>
        </div>
        <div class="phase-lessons-list">
          <a href="/blog-rust/54-webassembly.html" class="curriculum-lesson-row"><div class="lesson-row-left"><span class="lesson-idx">54</span><div class="lesson-info"><span class="lesson-title">54. WebAssembly</span><span class="lesson-subtopics">What is WebAssembly? · Rust to Wasm · wasm-bindgen · JS interop · web-sys DOM interaction · Performance</span></div></div><div class="lesson-row-right"><span class="lesson-btn">Read Chapter <span class="arrow">→</span></span></div></a>
          <a href="/blog-rust/55-advanced-cargo.html" class="curriculum-lesson-row"><div class="lesson-row-left"><span class="lesson-idx">55</span><div class="lesson-info"><span class="lesson-title">55. Advanced Cargo</span><span class="lesson-subtopics">Cargo feature flags · Optional dependencies · build.rs scripts · Release profiles · Cross compilation · cargo audit</span></div></div><div class="lesson-row-right"><span class="lesson-btn">Read Chapter <span class="arrow">→</span></span></div></a>
        </div>
      </div>
    ...
    <div class="faq-card">
      <h4><span style="background:rgba(183,65,14,0.15); color:#f97316; padding:2px 8px; border-radius:4px; font-size:12px; margin-right:4px;">Q</span> Why is Rust preferred for WebAssembly?</h4>
      <p>Rust compiles directly to lean WebAssembly binary modules without bundling a runtime or garbage collector, enabling near-native browser performance.</p>
    </div>

    <div class="faq-card">
      <h4><span style="background:rgba(183,65,14,0.15); color:#f97316; padding:2px 8px; border-radius:4px; font-size:12px; margin-right:4px;">Q</span> What are Cargo feature flags?</h4>
      <p>Feature flags allow conditional compilation of dependencies and code modules, enabling users to opt into lightweight or extra capabilities without bloating binaries.</p>
    </div>
...
console.log('✅ Generated public/blog-rust.html master index page successfully with all 55 chapters!');
