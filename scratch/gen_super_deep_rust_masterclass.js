...
function makePage(chNum, filename, pageTitle, metaDesc, phaseTag, phaseTitle, coveredText, bodySections, prevLink, prevTitle, nextLink, nextTitle) {
...
<script src="/site-nav.js" defer></script>
  ...
  console.log(`  🔥 MASSIVE ENRICHMENT: ${filename} (${(fullHtml.length / 1024).toFixed(1)}KB)`);
}
