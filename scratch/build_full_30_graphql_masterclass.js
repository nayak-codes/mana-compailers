...
// 2. Define Complete 30-Chapter GraphQL Masterclass Data Structure across 10 Phases
const graphqlPhases = [
  {
    phaseTag: 'Phase 01', phaseTitle: 'GraphQL Introduction', icon: '🚀',
    chapters: [
      {
        num: 1, file: '01-what-is-graphql.html', title: 'GraphQL Ante Enti?',
...
Main operations: HTTP methods (REST) vs Query, mutation, subscription (GraphQL) */`
  ...
  },
  {
    ...
    chapters: [
      {
        num: 3, file: '03-graphql-project-setup.html', title: 'GraphQL Project Setup',
      ...
      {
        num: 4, file: '04-first-graphql-server.html', title: 'First GraphQL Server',
...
type Query {
  ...
  description: String
      ...
      {
        num: 11, file: '11-interfaces-and-unions.html', title: 'Interfaces and Unions',
...
query Search {
  ...
  {
    phaseTag: 'Phase 04', phaseTitle: 'Queries, Mutations & Subscriptions', icon: '⚡',
    chapters: [
      {
        num: 12, file: '12-writing-queries.html', title: 'Writing Queries',
        subtopics: 'Query syntax · Field selection · Nested queries · Arguments · Aliases · Variables ($id: ID!) · Directives (@include, @skip) · Fragments',
        summary: 'Request precise data fields, pass query variables, alias duplicate fields, and reuse field sets using Fragments.',
        resource: 'Query', method: 'POST', url: '/graphql',
        reqEx: `query GetCourse($id: ID!) {\n  myCourse: course(id: $id) {\n    title\n    level\n  }\n}`,
        resEx: `200 OK\n{\n  "data": {\n    "myCourse": { "title": "Python", "level": "BEGINNER" }\n  }\n}`,
        statusCode: '200 OK',
        code: `query GetCourse($id: ID!) {
  myCourse: course(id: $id) {
    title
    level
  }
      ...
      {
        num: 13, file: '13-writing-mutations.html', title: 'Writing Mutations',
        subtopics: 'Mutation syntax · Creating resources · Updating resources · Deleting resources · Passing input objects · Payload pattern · Returning affected entities',
        summary: 'Execute state-modifying data operations (Create, Update, Delete) using GraphQL Mutations and Input types.',
        resource: 'Mutation', method: 'POST', url: '/graphql',
        reqEx: `mutation CreateNewCourse($input: CreateCourseInput!) {\n  createCourse(input: $input) {\n    id\n    title\n  }\n}`,
        resEx: `200 OK\n{\n  "data": {\n    "createCourse": { "id": "105", "title": "Go Fundamentals" }\n  }\n}`,
        statusCode: '200 OK',
        code: `mutation CreateNewCourse($input: CreateCourseInput!) {
  createCourse(input: $input) {
    id
    title
  }
      ...
      {
        num: 14, file: '14-subscriptions.html', title: 'Subscriptions & Real-Time Data',
        subtopics: 'Subscription syntax · WebSocket transport · PubSub events · AsyncIterators · Real-time notifications · Event filtering · Scaling Subscriptions',
        summary: 'Stream real-time server events to clients over persistent WebSocket connections using GraphQL Subscriptions.',
        resource: 'Subscription', method: 'WS', url: 'wss://api.ourcompiler.com/graphql',
        reqEx: `subscription OnCourseAdded {\n  courseAdded {\n    id\n    title\n  }\n}`,
        resEx: `101 Switching Protocols -> Streamed Event Data: { "courseAdded": { "title": "Rust" } }`,
        statusCode: '101 Switching Protocols',
        code: `subscription OnCourseAdded {
  courseAdded {
    id
    title
  }
  ...
  {
    phaseTag: 'Phase 05', phaseTitle: 'Resolvers & Execution Architecture', icon: '🧩',
    chapters: [
      {
        num: 15, file: '15-resolver-functions.html', title: 'Resolver Functions',
        subtopics: 'Resolver signature (parent, args, context, info) · Parent parameter · Arguments · Context injection · Info AST · Async resolvers · Database integration',
        summary: 'Understand the four resolver parameters (parent, args, context, info) and fetch data from databases or external microservices.',
        resource: 'Resolver', method: 'POST', url: '/graphql',
        reqEx: `const resolvers = {\n  Query: {\n    course: (_, { id }, { db }) => db.getCourse(id)\n  }\n};`,
        resEx: `200 OK\n{\n  "data": { "course": { "title": "Python" } }\n}`,
        statusCode: '200 OK',
        code: `const resolvers = {
  Query: {
    course: async (_, { id }, { db }) => {
      ...
      {
        num: 16, file: '16-nested-resolvers.html', title: 'Nested Resolvers',
        subtopics: 'Field-level resolvers · Parent object access · Relational data fetching · Lazy loading · Resolver tree execution',
        summary: 'Write field-level resolvers to automatically fetch nested object relationships on demand.',
        resource: 'NestedResolver', method: 'POST', url: '/graphql',
        reqEx: `const resolvers = {\n  Course: {\n    lessons: (parent, _, { db }) => db.getLessons(parent.id)\n  }\n};`,
        resEx: `200 OK\n{\n  "data": { "course": { "lessons": [{ "title": "Variables" }] } }\n}`,
        statusCode: '200 OK',
        code: `const resolvers = {
  Course: {
    lessons: async (parent, _, { db }) => {
      return await db.lessons.find({ courseId: parent.id });
    }
  }
};`
      },
      {
        num: 17, file: '17-dataloader.html', title: 'N+1 Query Problem & DataLoader',
        subtopics: 'N+1 query problem · Batching requests · In-memory caching · DataLoader library · Batch function · Request-scoped DataLoader instances',
        summary: 'Eliminate N+1 database performance bottlenecks by batching and caching entity requests with Facebook DataLoader.',
        resource: 'DataLoader', method: 'POST', url: '/graphql',
        reqEx: `const batchLessons = async (courseIds) => { ... };\nconst lessonLoader = new DataLoader(batchLessons);`,
        resEx: `200 OK\n(Single SQL Query: SELECT * FROM lessons WHERE course_id IN (1, 2, 3))`,
        statusCode: '200 OK',
        code: `const DataLoader = require('dataloader');

const lessonLoader = new DataLoader(async (courseIds) => {
  const lessons = await db.lessons.findMany({ courseId: { $in: courseIds } });
  ...
  {
    phaseTag: 'Phase 06', phaseTitle: 'Authentication, Security & Performance', icon: '🔒',
    chapters: [
      {
        num: 18, file: '18-graphql-authentication.html', title: 'Authentication in GraphQL',
        subtopics: 'JWT headers (Authorization: Bearer) · Context authentication · Request decoding · Unauthenticated errors · User injection in context',
        summary: 'Authenticate GraphQL requests by decoding JWT Bearer tokens in HTTP headers and injecting current user into context.',
        resource: 'Auth', method: 'POST', url: '/graphql',
        reqEx: `POST /graphql\nAuthorization: Bearer token_abc123\n\nquery { me { email } }`,
        resEx: `200 OK\n{\n  "data": { "me": { "email": "balaji@example.com" } }\n}`,
        statusCode: '200 OK',
  ...
  context: ({ req }) => {
    ...
    return { user };
      ...
      {
        num: 19, file: '19-authorization-and-directives.html', title: 'Authorization & Directives',
        subtopics: 'Field-level authorization · Role checks (RBAC) · Schema directives (@auth) · Custom directive visitors · Context role verification',
        summary: 'Enforce field-level role-based authorization rules using custom schema directives like @auth(role: ADMIN).',
        resource: 'Directive', method: 'POST', url: '/graphql',
  ...
  deleteCourse(id: ID!): Boolean! @auth(role: ADMIN)
      ...
      {
        num: 20, file: '20-graphql-security.html', title: 'Security & Protection',
        subtopics: 'Query depth limiting · Query complexity analysis · Disabling introspection in production · Rate limiting · Malicious query prevention',
        summary: 'Harden GraphQL APIs against Denial of Service attacks using query depth limits, complexity scoring, and disabling introspection.',
        resource: 'Security', method: 'POST', url: '/graphql',
        reqEx: `query DeepQuery { user { friends { friends { friends ... } } } }`,
        resEx: `400 Bad Request\n{\n  "errors": [{ "message": "Query exceeds maximum allowed depth of 5" }]\n}`,
...
const server = new ApolloServer({
  ...
  {
    phaseTag: 'Phase 07', phaseTitle: 'Client Integration & State', icon: '💻',
    chapters: [
      {
        num: 21, file: '21-client-side-graphql.html', title: 'Client-Side GraphQL',
        subtopics: 'HTTP POST requests · fetch API · cURL command · Apollo Client · Relay · Urql overview · Sending GraphQL payloads',
        summary: 'Execute GraphQL queries and mutations from browser clients using native fetch API, cURL, or Apollo Client.',
  ...
  body: JSON.stringify({
    query: \`query { courses { id title } }\`
      ...
      {
        num: 22, file: '22-apollo-client-basics.html', title: 'Apollo Client Basics',
        subtopics: 'ApolloProvider · useQuery hook · useMutation hook · InMemoryCache · Normalized caching · Optimistic UI updates · Refetching queries',
        summary: 'Integrate Apollo Client in React applications for seamless data fetching, normalized in-memory caching, and optimistic UI updates.',
        resource: 'ApolloReact', method: 'POST', url: '/graphql',
        reqEx: `const { data, loading } = useQuery(GET_COURSES);`,
        resEx: `200 OK\n(React UI Component Renders Data Automatically)`,
        statusCode: '200 OK',
...
function CourseList() {
  ...
  return <ul>{data.courses.map(c => <li key={c.id}>{c.title}</li>)}</ul>;
}`
      },
      {
        num: 23, file: '23-fragment-colocation.html', title: 'Fragment Colocation',
        subtopics: 'GraphQL Fragments · Fragment colocation · Component data requirements · Reusing fragment selections · Apollo cache normalization',
        summary: 'Colocate component data requirements using GraphQL Fragments to decouple React components from parent queries.',
        resource: 'Fragment', method: 'POST', url: '/graphql',
        reqEx: `fragment CourseCardFields on Course {\n  id\n  title\n  level\n}`,
        resEx: `200 OK\n{\n  "data": { "course": { "id": "1", "title": "Python", "level": "BEGINNER" } }\n}`,
        statusCode: '200 OK',
        code: `const COURSE_CARD_FRAGMENT = gql\`
...
\`;`
  ...
  {
    phaseTag: 'Phase 08', phaseTitle: 'Advanced Schema Architecture & Federation', icon: '🌐',
    chapters: [
      {
        num: 24, file: '24-apollo-federation.html', title: 'Apollo Federation & Subgraphs',
        subtopics: 'Microservices with GraphQL · Apollo Federation · Subgraphs · Federated Gateway · @key directive · @extends directive · Cross-service entity resolution',
        summary: 'Compose modular microservices into a unified graph using Apollo Federation subgraphs and entity keys.',
        resource: 'Federation', method: 'POST', url: '/gateway',
        reqEx: `type Course @key(fields: "id") {\n  id: ID!\n  title: String!\n}`,
        resEx: `200 OK\n(Unified Federated Schema Response across Subgraphs)`,
        statusCode: '200 OK',
        code: `@key(fields: "id")
extend type User @key(fields: "id") {
  ...
  reviews: [Review!]!
      ...
      {
        num: 25, file: '25-code-first-vs-schema-first.html', title: 'Code-First vs Schema-First',
        subtopics: 'Schema-First (GraphQL SDL) · Code-First (TypeGraphQL, Pothos, Nexus) · TypeScript class decorators · Type safety · Trade-offs',
        summary: 'Compare Schema-First SDL type definitions with Code-First TypeScript class decorator architectures.',
        resource: 'CodeFirst', method: 'POST', url: '/graphql',
        reqEx: `@ObjectType()\nclass Course {\n  @Field(() => ID) id: string;\n}`,
        resEx: `200 OK\n(Auto-generated GraphQL Schema from TS Classes)`,
        statusCode: '200 OK',
        code: `@ObjectType()
class Course {
  @Field(() => ID)
  ...
  title: string;
      ...
      {
        num: 26, file: '26-custom-directives.html', title: 'Custom Directives',
        subtopics: 'Defining directives (@upper, @deprecated, @cacheControl) · Directive visitors · Schema transformations · Metadata decoration',
        summary: 'Write custom schema directives to transform field outputs dynamically (e.g. @upper for uppercase strings).',
        resource: 'CustomDirective', method: 'POST', url: '/graphql',
        reqEx: `type Query {\n  title: String! @upper\n}`,
        resEx: `200 OK\n{\n  "data": { "title": "PYTHON MASTERCLASS" }\n}`,
        statusCode: '200 OK',
  ...
  {
    phaseTag: 'Phase 09', phaseTitle: 'Testing, Tooling & Monitoring', icon: '🛠️',
    chapters: [
      {
        num: 27, file: '27-graphql-codegen.html', title: 'GraphQL Code Generator',
        subtopics: 'GraphQL Code Generator (graphql-codegen) · Auto-generating TypeScript types · React hooks generation · Schema contract sync',
        summary: 'Automatically generate 100% type-safe TypeScript interfaces and React query hooks using GraphQL Code Generator.',
        resource: 'CodeGen', method: 'POST', url: '/graphql',
        reqEx: `npx graphql-codegen --config codegen.yml`,
        resEx: `✅ Generated src/generated/graphql.ts with full TypeScript types!`,
        statusCode: '200 OK',
        code: `schema: "http://localhost:4000/graphql"
...
generates:
  src/generated/graphql.ts:
    plugins:
      ...
      {
        num: 28, file: '28-testing-graphql-apis.html', title: 'Testing GraphQL APIs',
        subtopics: 'Mocking resolvers · Integration testing · Apollo Server testUtils · executeOperation · Jest test runner · Asserting GraphQL errors',
        summary: 'Write automated unit and integration test specs verifying GraphQL operations and error responses with Apollo testUtils.',
        resource: 'Test', method: 'POST', url: '/graphql',
        reqEx: `const res = await testServer.executeOperation({ query: 'GET_COURSES' });`,
        resEx: `200 OK\n(Jest: expect(res.body.kind).toBe('single'))`,
        statusCode: '200 OK',
        code: `const response = await testServer.executeOperation({
  query: 'query { courses { id title } }'
});
expect(response.body.singleResult.data.courses).toHaveLength(1);`
      },
      {
        num: 29, file: '29-graphql-monitoring.html', title: 'Monitoring & Performance',
        subtopics: 'Apollo Studio · Execution tracing · Query latency monitoring · Error tracking · Field usage metrics · Deprecation tracking',
        summary: 'Monitor GraphQL API performance, resolver latency metrics, and error rates using Apollo Studio instrumentation.',
        resource: 'Monitoring', method: 'POST', url: '/graphql',
        reqEx: `ApolloServerPluginUsageReporting()`,
        resEx: `200 OK\n(Metrics reported to Apollo Studio Dashboard)`,
        statusCode: '200 OK',
        code: `/* Apollo Studio Metrics Active: Tracing Resolver Latencies & Error Counts */`
      }
    ]
  },
  {
    phaseTag: 'Phase 10', phaseTitle: 'Certification & Knowledge Check', icon: '🏆',
    chapters: [
      {
        num: 30, file: '30-graphql-quiz.html', title: 'GraphQL Practice Quiz',
        subtopics: 'Comprehensive GraphQL Knowledge Check · 30 Multiple Choice Certification Exam Questions · Schema, Resolvers, Auth, Subscriptions & Performance',
        ...
        statusCode: '200 OK',
        code: `/* GraphQL Masterclass Certification Quiz Active! */`
      }
    ]
  }
];
...
<head>
  ...
  <title>GraphQL Complete Roadmap — 30 Chapters, 10 Phases (2026 Edition) | Our Compiler</title>
  <meta name="description" content="Master GraphQL schema design, SDL types, Query, Mutation, Subscriptions, Apollo Server, DataLoader, Authentication, Directives, Apollo Client, Federation, Tooling, and Testing with our complete 30-chapter roadmap across 10 phases." />
...
<div class="layout">
  ...
  <main class="content">
    ...
    <h1 class="page-title">GraphQL Complete Masterclass (30 Chapters, 10 Phases)</h1>
    ...
    <div class="topic-pill-box">
      ...
      <span class="topic-pill-text">GraphQL Ante Enti? · GraphQL vs REST · Project Setup &amp; Folder Structure · Schema SDL &amp; Root Types · Scalars, Objects, Enums &amp; Input Types · Interfaces &amp; Unions · Writing Queries, Mutations &amp; Subscriptions · Resolver Signature &amp; Context · N+1 Problem &amp; DataLoader · Auth, Security &amp; Directives · Apollo Client &amp; Fragments · Apollo Federation &amp; Subgraphs · Testing, Codegen &amp; Quiz</span>
    </div>

    <div class="intro-box">
      <p>Welcome to <strong>Our Compiler's GraphQL Complete Master Course</strong>. GraphQL is the modern query language and execution engine empowering client applications to request exact data requirements. This comprehensive 30-chapter bootcamp guides you through GraphQL schema design, SDL types, resolvers, DataLoader optimization, JWT authentication, Apollo Client, Federation subgraphs, and testing production GraphQL servers.</p>
    </div>
    ...
    <div style="background:linear-gradient(135deg,rgba(225,0,152,0.12),rgba(20,24,32,0.6));border:1px solid rgba(225,0,152,0.3);border-radius:12px;padding:24px;margin:28px 0;">
      ...
      <p style="color:var(--text2);margin-bottom:16px;font-size:14.5px;">Choose where to start: explore GraphQL introduction, schema types, DataLoader, Apollo Client, or Apollo Federation subgraphs:</p>
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        ...
        <a href="/blog-graphql/06-schema-basics.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 3: Schema Basics →</a>
        <a href="/blog-graphql/12-writing-queries.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 4: Queries &amp; Mutations →</a>
        <a href="/blog-graphql/17-dataloader.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 5: DataLoader →</a>
        <a href="/blog-graphql/22-apollo-client-basics.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 7: Apollo Client →</a>
        <a href="/blog-graphql/24-apollo-federation.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 8: Apollo Federation →</a>
      </div>
    </div>
    ...
    <div class="author">
      ...
      <div>
        ...
        <span>GraphQL Complete Masterclass · 30 Chapters · 10 Phases · 2026 Edition</span>
      </div>
    </div>
...
// 4. Generate all 30 Chapter HTML Files inside public/blog-graphql/ adhering strictly to the 18-Section Lesson Layout
...
<div class="layout">
  ...
  <main class="content">
    ...
    <!-- 4. Resource / Schema design -->
    <div class="section-title"><span class="num">4</span>Resource &amp; Schema Design</div>
    <div class="section-body">
      <p>GraphQL Schema Type / Entity: <code>${ch.resource}</code>. GraphQL schemas use SDL (Schema Definition Language) to define explicit types, fields, and relationships.</p>
    </div>

    <!-- 5. GraphQL operation type -->
    <div class="section-title"><span class="num">5</span>GraphQL Operation Type</div>
    <div class="section-body">
    ...
    <!-- 6. Endpoint URL / Sandbox -->
    <div class="section-title"><span class="num">6</span>Endpoint URL / Sandbox</div>
    <div class="section-body">
      <div class="code-block">
        <div class="code-block-header"><span class="lang-tag">Target Endpoint URL</span></div>
        <pre><code>POST ${ch.url}</code></pre>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="code-block">
        <div class="code-block-header"><span class="lang-tag">GraphQL Operation Request Example</span></div>
    ...
    <div class="section-body">
      <div class="code-block">
        <div class="code-block-header"><span class="lang-tag">GraphQL JSON Response Example</span></div>
        <pre><code>${ch.resEx}</code></pre>
      </div>
    </div>

    <!-- 9. Status code -->
    <div class="section-title"><span class="num">9</span>Status Code Behavior</div>
    <div class="section-body">
      <div class="card" style="background:var(--bg2);padding:14px 18px;border-radius:8px;margin:16px 0;border-left:4px solid #e10098;">
        <strong style="color:#e10098;">HTTP Response Status: ${ch.statusCode}</strong>
        <p style="margin-top:6px;font-size:13.5px;color:var(--text2);">GraphQL servers always return <code>HTTP 200 OK</code> for valid GraphQL operations, conveying errors inside the top-level <code>errors</code> JSON array envelope.</p>
      </div>
    </div>

    <!-- 10. Server-side flow / Resolver execution -->
    <div class="section-title"><span class="num">10</span>Server-Side Flow &amp; Resolver Execution</div>
    <div class="section-body">
      <div class="diagram-box">GraphQL HTTP POST Request -> AST Parsing & Schema Validation -> Root Resolver Execution -> Nested Resolver Tree Walk -> DataLoader Batching -> JSON Data Payload Response</div>
    </div>

    <!-- 11. Validation -->
    <div class="section-title"><span class="num">11</span>Validation</div>
    <div class="section-body">
      <p>GraphQL engine automatically validates incoming query strings against the target Schema definition before resolver execution. Unrecognized fields or incorrect scalar types trigger schema validation errors before database execution.</p>
    </div>

    <!-- 12. Database operation -->
    <div class="section-title"><span class="num">12</span>Database Operation / Service Execution</div>
    <div class="section-body">
      <p>Resolvers execute database operations or call underlying microservices using ORM queries (e.g. Prisma, TypeORM, Mongoose), utilizing DataLoader to batch parallel ID lookups into single SQL queries.</p>
    </div>
    ...
    <div class="section-body">
      <div class="callout" style="margin-bottom:24px;">
        ...
        <ul style="margin:8px 0 0 18px;line-height:1.7;">
          <li>Causing N+1 query database bottlenecks by fetching nested relationships inside un-batched field resolvers.</li>
          <li>Forgetting to secure introspection or query depth in production, exposing full schema definitions to public scanners.</li>
          <li>Overusing custom scalars when built-in primitives or Input objects suffice.</li>
          <li>Exposing sensitive database fields directly in GraphQL schemas without context authentication checks.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="section-body">
      <div style="background:var(--bg3);border:1px solid var(--border);border-radius:10px;padding:18px 22px;margin-bottom:24px;">
        <strong style="color:#e10098;display:block;margin-bottom:8px;">🎯 Hands-On Challenge:</strong>
        <p>Implement a GraphQL schema and resolver for <strong>${ch.title}</strong> using Apollo Server or GraphQL Yoga. Test your operation in Apollo Sandbox or GraphQL IDE!</p>
      </div>
    </div>
    ...
    <div class="section-body">
      <ul style="line-height:1.8;margin-left:20px;">
        ...
        <li>Follow GraphQL SDL best practices and DataLoader batching conventions.</li>
      </ul>
    </div>
...
console.log('✅ Generated all 30 GraphQL Masterclass chapter files in public/blog-graphql/ successfully!');
