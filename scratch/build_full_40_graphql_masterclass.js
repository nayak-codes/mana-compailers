...
// 2. Define Complete 40-Chapter GraphQL Masterclass Data Structure across 14 Phases
const graphqlPhases = [
  {
...
query Search {
  ...
  },
  {
    ...
    chapters: [
      {
        num: 12, file: '12-basic-queries.html', title: 'Basic Queries',
...
query GetCourses {
  ...
  Query: {
    courses: async (_, args, context) => {
      ...
      {
        num: 18, file: '18-resolver-arguments-and-context.html', title: 'Resolver Arguments and Context',
  ...
  Course: {
    lessons: async (parent, _, { lessonLoader }) => {
      ...
      {
        num: 20, file: '20-execution-and-validation.html', title: 'Execution and Validation',
...
1. Parse AST -> 2. Validate AST against Schema -> 3. Execute Resolvers -> 4. Return Data & Errors */`
  ...
  },
  {
    ...
    chapters: [
      {
        num: 21, file: '21-mutation-basics.html', title: 'Mutation Basics',
  ...
  createCourse(input: CreateCourseInput!): Course!
      ...
      {
        num: 22, file: '22-mutation-inputs-and-payloads.html', title: 'Mutation Inputs and Payloads',
...
type UserError {
  ...
  {
    phaseTag: 'Phase 08', phaseTitle: 'Pagination and Connections', icon: '📑',
    chapters: [
      {
...
type PageInfo {
  ...
  endCursor: String
      ...
      {
        num: 28, file: '28-filtering-and-sorting.html', title: 'Filtering and Sorting',
...
input CourseSortInput {
  ...
  {
    phaseTag: 'Phase 09', phaseTitle: 'Security & Rate Limiting', icon: '🛡️',
    chapters: [
      {
        num: 29, file: '29-graphql-authentication.html', title: 'Authentication & Authorization',
        subtopics: 'JWT token decoding in context · Role-based @auth directives · Field security · Request context user injection · Unauthenticated errors · Role claims',
        summary: 'Decode JWT tokens in HTTP headers, inject current user into context, and enforce field-level authorization.',
      ...
      {
        num: 30, file: '30-security-and-protection.html', title: 'Security & Protection',
        subtopics: 'Query depth limiting · Complexity scoring · Disabling introspection in production · Rate limiting · Malicious query protection',
        summary: 'Harden GraphQL servers against DoS queries using query depth limits, complexity scores, and disabling introspection in production.',
        resource: 'Security', method: 'POST', url: '/graphql',
        reqEx: `query DeepQuery { user { friends { friends { friends ... } } } }`,
        resEx: `400 Bad Request\n{\n  "errors": [{ "message": "Query depth 6 exceeds maximum allowed depth 5" }]\n}`,
        statusCode: '400 Bad Request',
        code: `/* Production Security Rules: Max Depth 5, Introspection Disabled */`
      }
    ]
  },
  {
    phaseTag: 'Phase 10', phaseTitle: 'Client Integration', icon: '💻',
    chapters: [
      {
        num: 31, file: '31-client-side-graphql.html', title: 'Client-Side GraphQL',
        subtopics: 'Native fetch API · cURL · Apollo Client setup · useQuery & useMutation hooks · Operation variables',
        summary: 'Execute GraphQL queries and mutations from web applications using native fetch or Apollo Client hooks.',
  ...
  body: JSON.stringify({ query: 'query { courses { id title } }' })
      ...
      {
        num: 32, file: '32-fragment-colocation-and-cache.html', title: 'Fragment Colocation & Cache',
        subtopics: 'Apollo Client InMemoryCache · Normalized caching · Fragment colocation in React components · Refetching queries',
        summary: 'Colocate GraphQL Fragments with React components for modular UI data requirements and normalized caching.',
        resource: 'ApolloCache', method: 'POST', url: '/graphql',
        reqEx: `const { data } = useQuery(GET_COURSES);`,
        resEx: `200 OK\n(React UI Component Renders Normalized Cache Data)`,
        statusCode: '200 OK',
  ...
  {
    phaseTag: 'Phase 11', phaseTitle: 'Advanced Architecture & Federation', icon: '🌐',
    chapters: [
      {
        num: 33, file: '33-apollo-federation.html', title: 'Apollo Federation & Subgraphs',
        subtopics: 'Microservices subgraphs · Gateway setup · @key directive · @extends entity keys · Federated graph composition',
        ...
        resEx: `200 OK\n(Federated Graph Execution across Subgraphs)`,
        statusCode: '200 OK',
        code: `@key(fields: "id")
extend type User @key(fields: "id") {
  id: ID! @external
      ...
      {
        num: 34, file: '34-code-first-vs-schema-first.html', title: 'Code-First vs Schema-First',
        subtopics: 'Schema-First (GraphQL SDL) · Code-First (TypeGraphQL, Pothos, Nexus) · TypeScript class decorators · Type safety',
...
class Course {
  @Field(() => ID) id: string;
      ...
      {
        num: 35, file: '35-custom-directives.html', title: 'Custom Directives',
        subtopics: 'Custom schema directive visitors · @upper · @cacheControl · Metadata decoration · Schema transformation',
  ...
  {
    phaseTag: 'Phase 12', phaseTitle: 'Testing, Tooling & Code Generation', icon: '🛠️',
    chapters: [
      {
        num: 36, file: '36-graphql-codegen.html', title: 'GraphQL Code Generator',
        ...
        statusCode: '200 OK',
        code: `npx graphql-codegen --config codegen.yml`
      },
      {
        num: 37, file: '37-testing-graphql-apis.html', title: 'Testing GraphQL APIs',
        subtopics: 'Mocking resolvers · Integration testing · Apollo Server testUtils · executeOperation · Jest test runner',
  ...
  query: 'query { courses { id title } }'
      ...
      {
        num: 38, file: '38-graphql-monitoring.html', title: 'Monitoring & Performance',
        subtopics: 'Apollo Studio · Execution tracing · Query latency monitoring · Error tracking · Field usage metrics',
  ...
  {
    phaseTag: 'Phase 13', phaseTitle: 'Projects & Platform Architecture', icon: '🏛️',
    chapters: [
      {
        num: 39, file: '39-our-compiler-graphql-api-project.html', title: 'Our Compiler GraphQL API Project',
        subtopics: 'Complete GraphQL API Architecture for Our Compiler Platform · Query root, Mutation root & Subscriptions for Auth, Tutorials, Compiler Run, Quizzes, Progress & Bookmarks',
        summary: 'Build a production-grade GraphQL API architecture for Our Compiler platform featuring full Schema SDL and Resolvers.',
        resource: 'PlatformAPI', method: 'POST', url: '/graphql',
        reqEx: `mutation RunCode($input: RunCodeInput!) {\n  runCode(input: $input) {\n    stdout\n    status\n  }\n}`,
        resEx: `200 OK\n{\n  "data": {\n    "runCode": {\n      "stdout": "Hello World!\\n",\n      "status": "SUCCESS"\n    }\n  }\n}`,
        statusCode: '200 OK',
        code: `type Query {
  languages: [Language!]!
  tutorial(slug: String!): Tutorial!
  me: User
}

type Mutation {
  login(input: LoginInput!): AuthPayload!
  runCode(input: RunCodeInput!): CodeSubmission!
}`
      }
    ]
  },
  {
    phaseTag: 'Phase 14', phaseTitle: 'Certification & Quiz', icon: '🏆',
    chapters: [
      {
        num: 40, file: '40-graphql-quiz.html', title: 'GraphQL Practice Quiz',
...
<head>
  ...
  <title>GraphQL Complete Roadmap — 40 Chapters, 14 Phases (2026 Edition) | Our Compiler</title>
  <meta name="description" content="Master GraphQL schema design, SDL types, Query, Mutation, Subscriptions, Apollo Server, DataLoader, Authentication, Directives, Apollo Client, Federation, Tooling, and Testing with our complete 40-chapter roadmap across 14 phases." />
...
<div class="layout">
  ...
  <main class="content">
    ...
    <h1 class="page-title">GraphQL Complete Masterclass (40 Chapters, 14 Phases)</h1>
    ...
    <div class="topic-pill-box">
      ...
      <span class="topic-pill-text">GraphQL Ante Enti? · GraphQL vs REST · Project Setup &amp; Folder Structure · Schema SDL &amp; Root Types · Scalars, Objects, Enums &amp; Input Types · Interfaces &amp; Unions · Basic Queries, Arguments &amp; Variables · Fragments &amp; Directives · Resolver Signature &amp; Context · Nested Resolvers &amp; DataLoader · Mutation Basics &amp; Payloads · Subscriptions &amp; Real-Time · Offset &amp; Cursor Pagination · Auth &amp; Security · Apollo Client &amp; Federation · Testing, Codegen &amp; Quiz</span>
    </div>

    <div class="intro-box">
      <p>Welcome to <strong>Our Compiler's GraphQL Complete Master Course</strong>. GraphQL is the modern query language and execution engine empowering client applications to request exact data requirements. This comprehensive 40-chapter bootcamp guides you through GraphQL schema design, SDL types, resolvers, DataLoader optimization, JWT authentication, Apollo Client, Federation subgraphs, and testing production GraphQL servers.</p>
    </div>
    ...
    <div style="background:linear-gradient(135deg,rgba(225,0,152,0.12),rgba(20,24,32,0.6));border:1px solid rgba(225,0,152,0.3);border-radius:12px;padding:24px;margin:28px 0;">
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        ...
        <a href="/blog-graphql/12-basic-queries.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 4: Basic Queries →</a>
        ...
        <a href="/blog-graphql/39-our-compiler-graphql-api-project.html" style="background:var(--bg3);border:1px solid var(--border);color:var(--text);font-weight:700;padding:10px 16px;border-radius:8px;text-decoration:none;">Phase 13: Platform API →</a>
      </div>
    </div>
    ...
    <div class="author">
      ...
      <div>
        ...
        <span>GraphQL Complete Masterclass · 40 Chapters · 14 Phases · 2026 Edition</span>
      </div>
    </div>
...
// 4. Generate all 40 Chapter HTML Files inside public/blog-graphql/ adhering strictly to the 18-Section Lesson Layout
...
console.log('✅ Generated all 40 GraphQL Masterclass chapter files in public/blog-graphql/ successfully!');
